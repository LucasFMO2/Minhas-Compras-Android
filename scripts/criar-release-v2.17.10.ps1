# Script para criar release pública v2.17.10 com APK específico
...
$apkPath = "app-release-v2.17.10.apk"
$apkName = "Minhas-Compras-v2.17.10.apk"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "CRIANDO RELEASE PUBLICA v2.17.10" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path $apkPath)) {
    ...
    Write-Host "Execute primeiro o script gerar-apk.ps1 para gerar o APK" -ForegroundColor Yellow
    exit 1
}
...
$releaseNotesPath = "release-notes-v2.17.10.md"
...
### Correção Importante
- Correção do problema de reutilização de listas arquivadas: listas agora voltam a aparecer corretamente após reutilização
...
$releaseData = @{
    tag_name = "v2.17.10"
    name = "Release v2.17.10 - Correção de Reutilização de Listas Arquivadas"
    body = $releaseBody
    draft = $false
    prerelease = $false
} | ConvertTo-Json
