# Script para criar release pública v2.17.9 com APK específico
...
$apkPath = "app-release-v2.17.9.apk"
$apkName = "Minhas-Compras-v2.17.9.apk"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "CRIANDO RELEASE PUBLICA v2.17.9" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$releaseNotesPath = "release-notes-v2.17.9.md"
...
### Correção Crítica
- Correção do sistema de arquivamento: listas arquivadas agora desaparecem corretamente da visualização de "listas ativas"
...
$releaseData = @{
    tag_name = "v2.17.9"
    name = "Release v2.17.9 - Correção do Sistema de Arquivamento"
    body = $releaseBody
    draft = $false
    prerelease = $false
} | ConvertTo-Json
