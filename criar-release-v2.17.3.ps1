...
$apkPath = "app-release-v2.17.3-icones-corrigidos.apk"
$apkName = "Minhas-Compras-v2.17.3-icones-corrigidos.apk"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "CRIANDO RELEASE PUBLICA v2.17.3" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# Dados da release
$releaseBody = @"
## Release v2.17.3 - Icones Corrigidos

### Melhorias
- Correcao de icones na barra de status
...
- Target SDK: 34
- Min SDK: 24
- Build: Icones Corrigidos

### Links
- Ver codigo-fonte: https://github.com/LucasFMO2/Minhas-Compras-Android
- Reportar problema: https://github.com/LucasFMO2/Minhas-Compras-Android/issues
"@

$releaseData = @{
    tag_name = "v2.17.3"
    name = "Release v2.17.3 - Icones Corrigidos"
    body = $releaseBody
    draft = $false
    prerelease = $false
} | ConvertTo-Json
